...
> Important Note: You should print 4 decimal points for all floating point numbers (e.g., use %.4f in your print statement). Also, make sure you don't print spaces between the elements.
...
For this test assignment you only need to submit `armin.py` to "Assignment #3" and see if you get all 100 points. In case of an error or wrong result, you can modify the file and resubmit it as many times as you want until the deadline of **Wednesday, March 29, 11:59 pm**.

### Late submissions

For full points, we will consider the version submitted to Gradescope 

* the day of the deadline **Monday, Mar 29, 11:59 pm**  
