...
Spring Semester 2021 - Supplementary Exercise 2

* DUE: Feb 25 (Thursday), 2021 11:59 PM 
  (One day extension due to Student Self-care Day on Tuesday)
...
2. Click on Directory and browse to the folder with CS1632_Spring2021/exercises/Supplement2.
...
1. cd into the CS1632_Spring2021/exercises/Supplement2 directory.
2. Invoke 'mvn test':
    ```
    > mvn test
    ```
...
[INFO] Finished at: 2021-02-20T22:08:14-04:00
[INFO] ------------------------------------------------------------------------
